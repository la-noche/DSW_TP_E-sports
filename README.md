...
|Req|Detalle|
|:-|:-|
|CRUD simple|1. CRUD Región<br>//2. CRUD Equipo *Elegimos este CRUD para la entrega del 03/05//.<br>3. CRUD Usuario<br>4. CRUD Tipo Juego *Elegimos este CRUD para la entrega del 03/05|
